...
def reset_data():
    ...
    models.update_results(2, experiment_id, [[1], 3, [1]])
    ...
    models.update_results(7, experiment_id, [[1], 1, [5]])
    ...
    models.update_results(14, experiment_id, [[1], 1, [5]])
    models.update_results(15, experiment_id, [[12], 1, [5]])
    models.update_results(16, experiment_id, [[1], 1, [5]])
    models.update_results(17, experiment_id, [[1], 1, [5]])
